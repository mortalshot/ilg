(() => {
    ...
    function fullVHfix() {
        document.querySelectorAll("[data-fullscreen]");
    ...
    function initSliders() {
        ...
        if (document.querySelector(".template18__slider")) new core(".template18__slider", {
    ...
    if (firstscreen) {
        if (!isMobile) window.addEventListener("resize", firstScreenHeight);
    ...
    function addGsapAnimation() {
        if (firstscreen) ScrollTrigger.create({
            trigger: firstscreen,
            onEnter: function() {
        ...
        if (toolsCards.length > 0) toolsCards.forEach((element => {
            ...
            elementTimeLine.fromTo(element, {
                opacity: 0,
                yPercent: 20
            }, {
                opacity: 1,
        ...
        if (tollsText) {
            ...
            tollsTextTimeLine.fromTo(tollsText, {
                opacity: 0,
                yPercent: 20
            }, {
                opacity: 1,
        ...
        if (grothImage) {
            ...
            grothTimeLine.fromTo(grothImage, {
                yPercent: -40
            }, {
                yPercent: 0
            });
